...
public:
    ...
    double deriv(int order, double x) const;                         // for left extrapolation
    ...
    const std::vector<double>& get_b() const { return m_b; }
    const std::vector<double>& get_c() const { return m_c; }
    const std::vector<double>& get_d() const { return m_d; }
